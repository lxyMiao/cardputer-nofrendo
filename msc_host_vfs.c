...
extern  void display_printf(const char *format, ...);
                                ...
                                msc_host_vfs_handle_t *vfs_handle)
{
    ...
    //display_printf(" ff_diskio_get_drive()\n");
    MSC_GOTO_ON_ERROR( ff_diskio_get_drive(&pdrv) );
    //display_printf(" ff_diskio_get_drive() end\n");
